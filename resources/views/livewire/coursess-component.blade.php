					...
					<div class="row">
						<div class="col-lg-8 left-contents">
							<div class="main-image">
								<img class="img-fluid" src="{{asset('assets/img/m-img.jpg')}}" alt="">
							</div>
						                    ...
						                    <div class="comment-list">
						                        <div class="single-comment justify-content-between d-flex">
						                            <div class="user justify-content-between d-flex">
						                                ...
						                                <div class="desc">
						                                    <h5><a href="#">Hasnur Jahan</a></h5>
						                                    <p class="date">November 4, 2020 at 3:12 pm </p>
						                                    <p class="comment">
						                    ...
						                    <div class="comment-list left-padding">
						                        <div class="single-comment justify-content-between d-flex">
						                            <div class="user justify-content-between d-flex">
						                                ...
						                                <div class="desc">
						                                    <h5><a href="#">Anika Talukder</a></h5>
						                                    <p class="date">November 4, 2017 at 3:12 pm </p>
						                                    <p class="comment">
						                                        Never say goodbye till the end comes!
						                                    </p>
						                                </div>
							...
							<ul>
								<li>
									<a class="justify-content-between d-flex" href="#">
										<p>Trainer’s Name</p> 
										<span class="or">Md. Shohel Arman</span>
									</a>
								</li>
								<li>
									<a class="justify-content-between d-flex" href="#">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-4 cta-right">
							<a class="primary-btn wh" href="#">view Course details</a>
						</div>
					</div>
				</div>	
			</section>
