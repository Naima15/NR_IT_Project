			...
			<section class="popular-courses-area section-gap courses-page">
				<div class="container">
					...
					<div class="row">
						<div class="single-popular-carusel col-lg-3 col-md-6">
							<div class="thumb-wrap relative">
								...
								<div class="meta d-flex justify-content-between">
									<p><span class="lnr lnr-users"></span> 300 <span class="lnr lnr-bubble"></span>35</p>
									<h4>$150</h4>
								</div>									
							</div>
							<div class="details">
						...
						<a href="courses.html" class="primary-btn text-uppercase mx-auto">Load More Courses</a>													
					</div>
				</div>	
			</section>
						...
						<div class="col-lg-6 col-md-6 search-course-left">
							...
							<div class="row details-content">
								<div class="col single-detials">
									...
									<p>
									At Academic Approach, we rigorously train our instructors to ensure they meet high standards for academic knowledge, teaching experience, and interpersonal skills. We hire professional educators with advanced education and demonstrated teaching experience who successfully mentor students to achieve growth and success. 
									</p>						
								</div>
								<div class="col single-detials">
						...
						<div class="active-upcoming-event-carusel">
							<div class="single-carusel row align-items-center">
								<div class="col-12 col-md-6 thumb">
									<img class="img-fluid" src="{{asset('assets/img/e1.jpg')}}" alt="">
								</div>
								<div class="detials col-12 col-md-6">
									<p>05 January, 2020</p>
									<a href="#"><h4>How can we 
									learn Web Development</h4></a>
									<p>
									The growing number of mobile devices browsing the web have challenged our design and development processes. In this seminar we will explore how techniques like responsive web design can help us rethink existing strategies, explore new options, and evolve so we can create websites that look great everywhere.
									</p>
								</div>
							</div>
							<div class="single-carusel row align-items-center">
								<div class="col-12 col-md-6 thumb">
									<img class="img-fluid" src="{{asset('assets/img/e2.jpg')}}" alt="">
								</div>
								<div class="detials col-12 col-md-6">
									<p>06 January, 2020</p>
									<a href="#"><h4>How to developing
									Graphics skill</h4></a>
									<p>
									Belancer is the largest IT training institution of Bangladesh, first and only freelancing marketplace for online works and it also works for skill development and unemployment reduction.
									</p>
								</div>
							</div>	
							<div class="single-carusel row align-items-center">
								...
								<div class="detials col-12 col-md-6">
									<p>07 January, 2018</p>
									<a href="#"><h4>Wordpress for Beginners
									A Complete Guide to Wordpress!</h4></a>
									<p>
									In 2020, it's never been easier to build a fantastic, responsive website that looks great on computers, tablets, and mobile phones.  You can learn Wordpress WITHOUT having to buy web hosting or a domain name. 
									I'll show you how you can set it all up on your own computer using free tools. 
									</p>
								</div>
							</div>	
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-4 cta-right">
							<a class="primary-btn wh" href="course details.html">view Course details</a>
						</div>
					</div>
				</div>	
			</section>
